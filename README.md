...
```math
\ce{$\unicode[goombafont; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; width: 130vw background: url('https://raw.githubusercontent.com/Mocab/Mocab/main/assets/background.png');]{x0000}$}
```
